...
Spelling
Follow Merriam-Webster.com.
          See also Spelling.


Nontechnical style
Follow The
          Chicago Manual of Style, 17th edition (subscription required).


Technical style
See the
          Microsoft
          Writing Style Guide. But consider whether Microsoft's guidance applies; some of it
          might apply only to Microsoft products and interfaces.\n\nThis style guide. If project-specific style guidelines don't provide explicit
    guidance, then follow this guide.\n\n\nType of question | Third-party reference\nSpelling | Follow Merriam-Webster.com.
          See also Spelling.\nNontechnical style | Follow The
          Chicago Manual of Style, 17th edition (subscription required).\nTechnical style | See the
          Microsoft
          Writing Style Guide. But consider whether Microsoft's guidance applies; some of it

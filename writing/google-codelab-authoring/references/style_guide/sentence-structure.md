Source: https://developers.google.com/style/sentence-structure\n\n# Sentence structure
  ...
  procedural instructions, see Procedures.\n\n\nRecommended | Not recommended\nFor more information, see [link to other document]. | See [link to other document] for more information.\nTo delete the entire document, click Delete. | Click Delete if you want to delete the entire document.\nIf your app is located in one of the following regions, using custom domains might add
        noticeable latency to responses: | Using custom domains might add noticeable latency to responses if your app is located

Source: https://developers.google.com/style/wordlist\n\n# Word list
  ...
  dictionary,
  Merriam-Webster. If there are multiple spellings in
  ...
  guide that can help you make those types of judgments:\n\n- Jargon\n- Inclusive language\n- Write for a global audience\n- Hyphens\n- Capitalization\n\nAs always, it's fine to deviate from our guidance if that serves your readers
    better. For more information, see Break the rules.\n\n\n## Word list\n\nAll word list entries have a link link

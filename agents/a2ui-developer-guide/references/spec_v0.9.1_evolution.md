...
* [A2UI Protocol v0.9](./spec_v0.9.1_core.md) (Previous Stable - what you're migrating from).
* [A2UI Protocol v0.9.1](./spec_v0.9.1_core.md) (Current - what you're migrating to).

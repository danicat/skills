...
[AG-UI](https://ag-ui.com/) is a **transport protocol** connecting agent backends to frontends with real-time state sync. A2UI is a **UI format**: the payload that describes what to render. They're complementary: use AG-UI as the pipe, A2UI as the content. AG-UI is a project by the [CopilotKit](https://copilotkit.ai) team, who also contributed the [A2UI Composer](https://a2ui.org/composer/). AG-UI has day-zero A2UI compatibility.
...
* **A2UI + A2A**: A2UI messages sent via the [A2A protocol](./concept_transports.md) for multi-agent systems.
...
* [What is A2UI?](./intro_what_is_a2ui.md): Protocol overview.
* [Transports](./concept_transports.md): How A2UI messages travel between agents and clients.
* [Where is A2UI Used?](https://a2ui.org/ecosystem/a2ui-in-the-world/): Case studies and adopters.

...
* **Core Library**:
  ...
  For example, see the [JavaScript web core library](https://github.com/a2ui-project/a2ui/blob/main/renderers/web_core/README.md).
* **Catalog Schema**:
...
* **Framework adapter**:
  ...
  See the [Angular adapter](https://github.com/a2ui-project/a2ui/blob/main/renderers/angular/README.md).
* **Catalog Implementation**:

  Implementation of the catalog schema for a framework.

  For example:
  - See the [Angular implementation of the basic catalog](https://github.com/a2ui-project/a2ui/blob/main/renderers/angular/src/v0_9/catalog/basic)

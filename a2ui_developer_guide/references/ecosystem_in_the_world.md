# ecosystem_in_the_world
Source: https://a2ui.org/ecosystem/a2ui-in-the-world/

# A2UI in the World[¶](#a2ui-in-the-world "Permanent link")
...
## Production Deployments[¶](#production-deployments "Permanent link")

### Google Opal: AI Mini-Apps for Everyone[¶](#google-opal-ai-mini-apps-for-everyone "Permanent link")
...
### Gemini Enterprise: Custom Agents for Business[¶](#gemini-enterprise-custom-agents-for-business "Permanent link")
...
### Flutter GenUI SDK: Generative UI for Mobile[¶](#flutter-genui-sdk-generative-ui-for-mobile "Permanent link")
...
### Google ADK: Agent Development Kit[¶](#google-adk-agent-development-kit "Permanent link")
...
## Partner Integrations[¶](#partner-integrations "Permanent link")

### AG-UI / CopilotKit: Full-Stack Agentic Framework[¶](#ag-ui-copilotkit-full-stack-agentic-framework "Permanent link")
...
### AG2: Multi-Agent Framework with Native A2UI[¶](#ag2-multi-agent-framework-with-native-a2ui "Permanent link")
...
### Google's AI-Powered Products[¶](#googles-ai-powered-products "Permanent link")
...
## Community Projects[¶](#community-projects "Permanent link")

The A2UI community is building exciting projects:

### Open Source Examples[¶](#open-source-examples "Permanent link")

* **Restaurant Finder** ([samples/agent/adk/restaurant\_finder](https://github.com/a2ui-project/a2ui/tree/main/samples/agent/adk/restaurant_finder))
...
### Third-Party Integrations[¶](#third-party-integrations "Permanent link")
...
### Community Contributions[¶](#community-contributions "Permanent link")

Have you built something with A2UI? [Share it with the community!](../community/)
...
* [Quickstart Guide](../../quickstart/) - Try the demo.
* [Agent Development](../../guides/agent-development/) - Build an agent.
* [Client Setup](../../guides/client-setup/) - Integrate a renderer.

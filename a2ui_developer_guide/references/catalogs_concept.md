...
[Catalog JSON Schema](https://github.com/a2ui-project/a2ui/blob/main/specification/v0_9/json/client_capabilities.json#L62C5-L95C6) is below
...
and the hello\_world\_banner implementation
...
Example A2UI Message from the agent defining the catalog\_id used in a surface
